        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* Approvals */}
              <li>
                <Link href="/approvals" className={linkClass(pathname.includes("approvals"))}>
              ...
              {/* Imports */}
              <li>
                <Link href="/imports" className={linkClass(pathname.includes("imports"))}>
                  <svg className="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup activeCondition={pathname === "/loans-list" || pathname === "/loan-calculator" || pathname.includes("loans")}>
                {(handleClick, open) => (
                  <React.Fragment>
                    <Link href="#" className={linkClass(pathname === "/loans-list" || pathname === "/loan-calculator" || pathname.includes("loans"))} onClick={groupClick(handleClick)}>
              ...
              <SidebarLinkGroup activeCondition={pathname === "/collection-list" || pathname === "/payment-posting" || pathname === "/statement-of-account" || pathname === "/problem-accounts" || pathname === "/renewable-borrowers"}>
                {(handleClick, open) => (
                  <React.Fragment>
                    <Link href="#" className={linkClass(pathname === "/collection-list" || pathname === "/payment-posting" || pathname === "/statement-of-account" || pathname === "/problem-accounts" || pathname === "/renewable-borrowers")} onClick={groupClick(handleClick)}>
                    ...
                    <div className={`translate transform overflow-hidden ${!open && "hidden"}`}>
                      <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                        ...
                        <li><Link href="/problem-accounts" className={subLinkClass(pathname === "/problem-accounts")}>Problem Accounts</Link></li>
                        <li><Link href="/renewable-borrowers" className={subLinkClass(pathname === "/renewable-borrowers")}>Renewable Borrowers</Link></li>
                      </ul>
                    </div>
                  </React.Fragment>
                )}
