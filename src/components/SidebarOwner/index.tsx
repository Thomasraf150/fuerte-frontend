        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* Payments */}
              <SidebarLinkGroup activeCondition={pathname === "/collection-list" || pathname === "/payment-posting" || pathname === "/statement-of-account" || pathname === "/problem-accounts"}>
                {(handleClick, open) => (
                  <React.Fragment>
                    <Link href="#" className={linkClass(pathname === "/collection-list" || pathname === "/payment-posting" || pathname === "/statement-of-account" || pathname === "/problem-accounts")} onClick={groupClick(handleClick)}>
