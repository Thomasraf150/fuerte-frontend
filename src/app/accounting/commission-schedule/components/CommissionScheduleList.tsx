...
import CommissionScheduleForm from './CommissionScheduleForm';
import { Plus } from 'react-feather';

const CommissionScheduleList: React.FC = () => {
...
export default CommissionScheduleList;