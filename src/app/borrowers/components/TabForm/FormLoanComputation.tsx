              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-4 border p-2">
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-gray-900">{dataComputedLoans?.monthly_amort}</h3>
                  </div>
                </li>
                <li className="flex items-center gap-4 border p-2">
                  <div>
                ...
                <li className="flex items-center gap-4 border p-2">
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-gray-900">{dataComputedLoans?.pn}</h3>
                  </div>
                </li>
                <li>
                  <span className="flex items-center">
                ...
                <li className="flex items-center gap-4 border p-2">
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-gray-900">{dataComputedLoans?.deductions?.udi}</h3>
                  </div>
                </li>
                <li className="flex items-center gap-4 border p-2">
                  <div>
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-gray-900">{dataComputedLoans?.deductions?.processing}</h3>
                  </div>
                </li>
                <li className="flex items-center gap-4 border p-2">
                  <div>
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-gray-900">{dataComputedLoans?.deductions?.collection}</h3>
                  </div>
                </li>
                <li className="flex items-center gap-4 border p-2">
                  <div>
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-gray-900">{dataComputedLoans?.deductions?.insurance}</h3>
                  </div>
                </li>
                <li className="flex items-center gap-4 border p-2">
                  <div>
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-gray-900">{dataComputedLoans?.deductions?.notarial}</h3>
                  </div>
                </li>
                <li className="flex items-center gap-4 border p-2">
                  <div>
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-strokedark font-bold">{dataComputedLoans?.total_deductions}</h3>
                  </div>
                </li>
                <li className="flex items-center gap-4 border p-2">
                  <div>
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-strokedark font-bold">{dataComputedLoans?.loan_proceeds}</h3>
                  </div>
                </li>
                <li>
                  <span className="flex items-center">
                ...
                <li className="flex items-center gap-4 border p-2">
                  ...
                  <div className="flex flex-1 items-center justify-end gap-2">
                    <h3 className="text-sm text-strokedark font-bold">{dataComputedLoans?.new_loan_proceeds}</h3>
                  </div>
                </li>
              </ul>
